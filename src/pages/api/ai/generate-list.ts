  ...
  if (isTestingMode) {
    ...
    try {
      ...
      if (error instanceof RateLimitError) {
        ...
        return rateLimitErrorResponse("Daily AI generation limit exceeded (5/day)", error.resetAt);
      }

      // Handle other quota check errors
      console.error("[AI Generate] Quota check error:", error);
      return errorResponse("quota_check_failed", "Failed to verify generation quota. Please try again.", 500);
    }
  }
